                        ...
                        success: function success(response) {
                            if (response.length < 0) {
                                ...
                                for (var i = 0; i < response.length; i++) {
                                    ...
                                    tr.append(
                                        $("<td>").append(response[i].ten)
                                    );
                                    tr.append(
                                        $("<td>").append(response[i].mota)
                                    );
                                    tr.append(
                                        $("<td>").append(response[i].soluong)
                                    );
                                    tr.append(
                                        $("<td>").append(response[i].tacgia)
                                    );
                                    tr.append(
                                        $("<td>").append(response[i].nhaxuatban)
                                    );
                                    tr.append(
                                        $("<td>").append(response[i].category !== null
                                            ? response[i].category.tendanhmuc
                                            : ""
                                    ));

...
@section('content')
    <div class="d-flex justify-content-end">
        <a class="btn btn-primary" href="{{route('category.index')}}">Thêm thể loại sách</a>
    </div>
    <form id="insert-form" class="book-form" method="POST" enctype="multipart/form-data" novalidate="">
        ...
        <div class="form-group">
            ...
            <input type="text" title="Please input your name" class="form-control" name="tensach" id="ten_sach"
        ...
        <div class="form-group">
            <label for="nhaxuatban">Chọn thể loại</label>
        ...
        <div class="form-group">
            ...
            <textarea required class="form-control" id="noidungsach" name="noidungsach"></textarea>
        </div>

...
@section('content')
    <form id="insert-form" class="book-form" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-group">
            ...
            <input type="text" title="Please input your name" class="form-control" name="tensach" id="ten_sach" oninvalid="this.setCustomValidity('Please enter a valid email address')" oninput="this.setCustomValidity('')
